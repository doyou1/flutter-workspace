...
class FocusImagePage extends StatelessWidget {
  const FocusImagePage({Key? key}) : super(key: key);
  static String routeName = '/miscs/focus_image';
...
class SmallCard extends StatelessWidget {
  const SmallCard({Key? key, required this.imageAssetName}) : super(key: key);
