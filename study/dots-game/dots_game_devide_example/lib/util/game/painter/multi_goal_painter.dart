...
import 'package:dots_game_devide_example/model/goal.dart';
...
class MultiGoalPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for(Goal g in goal){
      final ga = Offset(cellSize * g.point.x, cellSize * g.point.y);
      final gb = Offset(cellSize * (g.point.x + 1), cellSize * (g.point.y + 1));
      goalShape.color = GoalColors[g.index];
      canvas.drawRect(Rect.fromPoints(ga, gb), goalShape);
    }
