...
import '../util/game/sink_hole_game_painter.dart';

class SinkHolePage extends StatefulWidget {
  const SinkHolePage({
    Key? key,
  }) : super(key: key);

  @override
  State<SinkHolePage> createState() => _SinkHolePageState();
}

class _SinkHolePageState extends State<SinkHolePage> with AutomaticKeepAliveClientMixin<SinkHolePage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            height: WIDGET_SIZE,
            child: CustomPaint(
              foregroundPainter: SinkHoleGamePainter(points),
            ),
          ),
          // 스위치 위젯
          Container(
